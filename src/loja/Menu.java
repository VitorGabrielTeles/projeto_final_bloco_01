...
import loja.repository.JogoRepository;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (opcao) {
                ...
                case 2:
                    System.out.print("ID: ");
                    int id = leia.nextInt(); leia.nextLine();
                    System.out.print("Nome: ");
                    String nome = leia.nextLine();
                    System.out.print("Preço: ");
                    double preco = leia.nextDouble(); leia.nextLine();
                    System.out.print("Gênero: ");
                    String genero = leia.nextLine();

                    repo.adicionar(new Jogo(id, nome, preco, genero));
                    keyPress();
                    break;

                case 3:
                    System.out.print("ID do jogo para remover: ");
